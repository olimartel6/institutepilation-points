...
const configs = {
  ...
  'la-peltrie': {
    ...
    logo: './logos/la-peltrie.png',
    logoLight: './logos/la-peltrie.png',
    favicon: '🍔',
    heroImage: './images/la-peltrie/hero.jpg',
    galleryImages: [
      './images/la-peltrie/sloppy-joe.png',
      './images/la-peltrie/club-homard.png',
      './images/la-peltrie/guedille-poulet.png',
    ],
    pointsPerDollar: 10,
    referralBonus: 75,
    visitBonus: 25,
